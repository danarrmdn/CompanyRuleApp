            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900">
                    ...
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <p class="text-lg font-bold text-gray-800">Company Rules Document</p>
                            <p class="text-sm text-gray-500 mt-1">▶ Creation / Modification</p>
                        </div>
                    ...
                    <form method="POST" action="{{ route('company-rules.store') }}" enctype="multipart/form-data" id="create-form">
                        @csrf
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <x-secondary-button type="button" class="me-4" onclick="document.getElementById('is-draft-input').value = '1'; document.getElementById('create-form').submit();">
                                {{ __('Save as Draft') }}
                            </x-secondary-button>
                            <x-primary-button>
                                {{ __('Submit') }}
